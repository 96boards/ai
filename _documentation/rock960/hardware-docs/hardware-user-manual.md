...
permalink: /documentation/rock960/hardware-docs/hardware-user-manual.md.html
---
...
- UART 2 is the default debug console and the default baud rate is 1.5Mbps. Check the [serial console debug](../guides/serial-console.md.html) for how to setup on PC.
